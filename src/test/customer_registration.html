...
<body class="bg-dark">
	<div class="container-fluid ">
		<div class="row">
			...
			<div class="col-sm-4 border rounded m-4" style="background-color: aliceblue;">
				<h1 class="display-5 text-center text-dark text-muli">Registration</h1>
				...
				<form class="p-1" action="register" method="post"
					...
					<div class="form-group p-1">
						...
						<small class="form-text text-muted">Mobile Number must have 10 digits</small>
					</div>
					...
					<!-- Address -->
					<div class="form-group p-1">
						<textarea class="form-control" placeholder="Enter address" id="address" name="address" rows="5"
							cols="10"></textarea>
					</div>
					<div class="form-group p-1">
						<button class="form-control btn btn-outline-primary btn-block" type="submit">Submit</button>
						<a href="#"><small class="form-text text-center">Already have account? Login Here!</small></a>
